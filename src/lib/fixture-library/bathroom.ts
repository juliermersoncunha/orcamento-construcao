...
export const BATHROOM_FIXTURES: FixtureSpec[] = [
  ...
  // ── RALO / CAIXA SIFONADA ─────────────────────────────────────────────────
  {
    ...
    electricalPoints: [],
    // Sem material: a caixa sifonada é lançada manualmente na Etapa 8, junto
    // com tubos e conexões. O equipamento segue declarando o ponto de ralo,
    // que é o que alimenta a validação de pontos.
    dependencies: [],
  },
  {
...
export const BATHROOM_DOOR_DEPENDENCIES: DependencySpec[] = [
  ...
  // Parafusos/buchas, espuma expansiva, folha de porta, soleira de granito,
  // batente/marco e kit de alisar saíram por decisão do usuário — lançados
  // manualmente na Etapa 8. Não recolocar sem precificar.
];
